...
<body>
  ...
  <section class="img-container"></section>
    ...
    <h2>게시글 내용 수정</h2>
    <form  action="/User_board/Update"  method="POST">
    ...
    <a class="btn-detail-link" href="/User_board/List?user_id=${user_id}&nowpage=${nowpage}">목록</a>
</td>
