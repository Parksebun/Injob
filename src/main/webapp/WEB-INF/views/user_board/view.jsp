  ...
  <main>
    ...
    <table id="table">
     ...
     <tr>
       ...
       <td colspan="4">
        <a class = "btn btn1" 
           href  = "/User_board/WriteForm?user_id=${ vo.user_id }&nowpage=${nowpage}">새 글쓰기</a>&nbsp;&nbsp;
        <a class = "btn btn1" 
           href  = "/User_board/UpdateForm?board_id=${ vo.board_id }&user_id=${ vo.user_id }&nowpage=${nowpage}">수정</a>&nbsp;&nbsp;
        <a class = "btn btn1" 
           href  = "/User_board/delete?board_id=${ vo.board_id }&user_id=${ vo.user_id}&nowpage=${nowpage}">삭제</a>&nbsp;&nbsp;
        <a class = "btn btn1" 
           href  = "/User_board/List?user_id=${ vo.user_id }&nowpage=${nowpage}">목록으로</a>&nbsp;&nbsp;
        <a class = "btn btn1" 
